...
const EditCompanyPage = () => {
  ...
  useEffect(() => {
    if (company) {
      ...
      setValue('foundedYear', company.foundedYear || '');
  ...
  const onSubmit = async (data: CompanyFormData) => {
    try {
      const formData = {
        ...data,
        ...(logoFile && { logo: logoPreview }),
        ...(coverFile && { coverImage: coverPreview }),
      };

      await updateCompanyMutation.mutateAsync(formData as any);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#172033]">Edit Company</h1>
        <p className="text-[#64748B] mt-2">Update your company profile</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex gap-4">
          <Button type="submit" disabled={updateCompanyMutation.isPending} className="flex-1">
